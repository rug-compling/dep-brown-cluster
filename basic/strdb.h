...
typedef void intvec_func(IntVec a); //simon
void read_text(const char *file, intvec_func *func, StrDB &db, bool read_cached, bool write_cached, bool incorp_new); //simon
